...
1. Pilih `Manage` pada *Administrative Menu*
2. Pilih **Configuration** - **Development** - **Maintenance Mode**
3. Isi form yang tersedia
4. Setelah selesai, klik **Save Configuration**

![1](https://raw.githubusercontent.com/purnamasftr/KOMDAT-JARKOM-DRUPAL/master/22.PNG)

![2](https://raw.githubusercontent.com/purnamasftr/KOMDAT-JARKOM-DRUPAL/master/23.PNG)
